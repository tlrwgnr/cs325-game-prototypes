BasicGame.Game = function(game) {
    ...
    this.enemy_defense = null;
    this.enemy_attack = null;
    this.enemy_fighters = null;
    this.enemy_ship = null;
    this.enemy_evading = false;
    ...
    this.enemyRoll = function() {
        this.roll = Math.ceil(Math.random() * 10);
        this.gametext.text = "Enemy rolls a " + this.roll;
    }
    ...
    this.attack = function() {
        ...
        if (!this.playerDidAction) {
            this.gametext.text = "You hit enemy for " + (this.enemy_evading ? Math.abs(Math.round((this.player_attack - this.enemy_defense)/2)) : Math.abs(this.player_attack - this.enemy_defense)) + " damage!" + (this.enemy_evading ? "The enemy is evading!" : "");
            this.enemy_health -= (this.enemy_evading ? Math.abs(Math.round((this.player_attack - this.enemy_defense)/2)) : Math.abs(this.player_attack - this.enemy_defense));
    ...
    this.enemyAttack = function() {
        ...
        this.gametext.text = "Enemy attacking!" + (this.player_evading ? "You're evading!" : "");
        this.player_health -= (this.player_evading ? Math.abs(Math.round(((this.enemy_attack - this.player_defense)/2))) : Math.abs(this.enemy_attack - this.player_defense));
        this.gametext_health.text = "Health:" + this.player_health
    }
    this.enemyEvade = function() {
        console.log("enemy evade");
        this.enemy_evading = true;
    ...
    this.create_enemy = function() {
        switch (Math.round(Math.random() * 4)) {
            case 0:
                ...
                this.enemy_defense = 20;
                this.enemy_attack = 10;
                this.enemy_fighters = 2;
                this.enemy_ship = 'carrier';
                break;
            case 1:
                this.enemy_health = 25;
                this.enemy_defense = 15;
                this.enemy_attack = 15;
                this.enemy_fighters = 1;
                this.enemy_ship = 'destroyer';
                break;
            case 2:
                this.enemy_health = 15;
                this.enemy_defense = 10;
                this.enemy_attack = 10;
                this.enemy_fighters = 1;
                this.enemy_ship = 'stealth_cruiser';
                break;
            case 3:
                this.enemy_health = 15;
                this.enemy_defense = 15;
    ...
    this.enemy_turn = function() {
        this.gametext.text = "Enemy turn!";
        console.log('enemy turn');
        this.enemyRoll();
        this.enemy_health += 1;
        this.enemy_defense += 1;
        this.enemy_attack += 1;
        this.enemy_fighters += 1;
        this.enemy_evading = false;
